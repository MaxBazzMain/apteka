        ...
        <div class="head-body">
          ...
          <div class="head-content">
            ...
            <div class="drag-text-head-block">
              <a href="./index.php" class="shop-head"><img class="current image-head-shop" src="./assets/images/icon/main-drag-icon.png"/>Лекарства</a>
            </div>
            ...
            <div class="drag-text-head-block">
              <a href="./login.php" class="shop-head"><img class="image-head-shop" src="./assets/images/icon/account-icon.png"/>Аккаунт</a>
            </div>
